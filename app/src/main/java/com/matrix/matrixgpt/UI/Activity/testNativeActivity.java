...
public class testNativeActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBannerContainer = (FrameLayout) findViewById(R.id.test_banner_container);
    ...
    private void loadBannerAd(String codeId) {
        ...
        mTTAdNative.loadNativeAd(adSlot, new TTAdNative.NativeAdListener() {
            ...
            public void onError(int code, String message) {
                MatrixToast.show(getApplicationContext(), "load error : " + code + ", " + message);
            }

            @Override
            public void onNativeAdLoad(List<TTNativeAd> ads) {
                if (ads.get(0) == null) {
                    Toast.makeText(getApplicationContext(), "ads内容:"+ads.get(0).getTitle(), Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void setAdData(final View nativeView, final TTNativeAd nativeAd) {
        ...
        nativeAd.registerViewForInteraction((ViewGroup) nativeView, imageViewList,
                clickViewList, creativeViewList, imgDislike, new TTNativeAd.AdInteractionListener() {

                    @Override
                    public void onAdClicked(View view, TTNativeAd ad) {
                        if (ad != null) {
                            MatrixToast.show(view.getContext(), "广告" + ad.getTitle() + "被点击");
                        }
                    }
                    ...
                    public void onAdCreativeClick(View view, TTNativeAd ad) {
                        if (ad != null) {
                            MatrixToast.show(view.getContext(), "广告" + ad.getTitle() + "被创意按钮被点击");
                        }
                    }
                    ...
                    public void onAdShow(TTNativeAd ad) {
                        if (ad != null) {
                            MatrixToast.show(getApplicationContext(), "广告" + ad.getTitle() + "展示");
                        }
                    }
                });
    ...
    private void bindDislikeAction(TTNativeAd ad, View dislikeView, boolean isCustomDislike) {
        if (isCustomDislike) {
            ...
            final MatrixDislikeDialog dislikeDialog = new MatrixDislikeDialog(getApplicationContext(), dislikeInfo);
            ...
            if (ttAdDislike != null) {
                ...
                ttAdDislike.setDislikeInteractionCallback(new TTAdDislike.DislikeInteractionCallback() {
                    ...
                    public void onSelected(int position, String value, boolean enforce) {
                        mBannerContainer.removeAllViews();
                        if (enforce) {
                            MatrixToast.show(getApplicationContext(), "NativeBannerActivity 原生banner sdk强制移除View ");
                        }
                    }
