...
public class ReadActivity extends BaseActivity{
    ...
    private void bindDataTrans() {
        read_view_title.setText(TAG_Intent.getStringExtra(mContext.getString(R.string.mTitle)));
        read_view_author.setText(TAG_Intent.getStringExtra(mContext.getString(R.string.mAuthor)));
        ...
        String test=mContext.getString(R.string.BackUrl)+mContext.getString(R.string.Url_GetFile)+
                TAG_Intent.getStringExtra(mContext.getString(R.string.mContent));
