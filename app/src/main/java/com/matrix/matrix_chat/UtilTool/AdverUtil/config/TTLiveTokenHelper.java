...
import com.matrix.matrix_chat.UtilTool.MatrixApplication;

/**
 * @ClassName TTLiveTokenHelper
 * @Author Create By Administrator
 * @Date 2023/4/17 0017 18:09
 */
public class TTLiveTokenHelper {
    ...
    private TTLiveTokenHelper() {
        final Context appContext = MatrixApplication.getAppContext();
